...
export default function AFKRaydiumForm() {
  const { raydiumStatus, setRaydiumStatus } = useAFKStatusStore();
  ...
  const handleChangeMinLPBurnPercentage = (e: number[]) => {
    const value = e[0];
    const isValid = /^[1-9]$|^[1-9][0-9]$|^100$/.test(value.toString());

    if (isValid) {
      setMinLPBurnPercentage(value);
    }
  };
  const handleChangeMaxLPBurnPercentage = (e: number[]) => {
    const value = e[0];
    const isValid = /^[1-9]$|^[1-9][0-9]$|^100$/.test(value.toString());

    if (isValid) {
      setMaxLPBurnPercentage(value);
    }
  };
  ...
  const handleChangeMinSupplyDeployedPercentage = (e: number[]) => {
    const value = e[0];
    const isValid = /^[1-9]$|^[1-9][0-9]$|^100$/.test(value.toString());

    if (isValid) {
      setMinSupplyDeployedPercentage(value);
    }
  };
  const handleChangeMaxSupplyDeployedPercentage = (e: number[]) => {
    const value = e[0];
    const isValid = /^[1-9]$|^[1-9][0-9]$|^100$/.test(value.toString());

    if (isValid) {
      setMaxSupplyDeployedPercentage(value);
    }
  };
  ...
  const handleChangeMinTopOnePercentage = (e: number[]) => {
    const value = e[0];
    const isValid = /^[1-9]$|^[1-9][0-9]$|^100$/.test(value.toString());

    if (isValid) {
      setMinTopOnePercentage(value);
    }
  };
  const handleChangeMaxTopTenPercentage = (e: number[]) => {
    const value = e[0];
    const isValid = /^[1-9]$|^[1-9][0-9]$|^100$/.test(value.toString());

    if (isValid) {
      setMaxTopTenPercentage(value);
    }
  };
  ...
  const handleStart = (e: FormEvent<HTMLFormElement>) => {
    ...
    setRaydiumStatus(!raydiumStatus);
            ...
            <div className="flex w-full flex-col gap-y-4">
              ...
              <div className="grid h-auto w-full grid-cols-2 gap-x-3 gap-y-4">
                <div className="col-span-1 flex h-[58px] w-full flex-col justify-between">
                  ...
                  <div className="relative flex h-[32px] w-full items-start justify-center">
                    <Slider
                      value={[minLPBurnPercentage]}
                      customValue={minLPBurnPercentage}
                      onValueChange={handleChangeMinLPBurnPercentage}
                      max={100}
                      step={1}
                    />
                  </div>
                ...
                <div className="col-span-1 flex h-[58px] w-full flex-col justify-between">
                  ...
                  <div className="relative flex h-[32px] w-full items-start justify-center">
                    <Slider
                      ...
                      customValue={maxLPBurnPercentage}
                      onValueChange={handleChangeMaxLPBurnPercentage}
                      max={100}
                      step={1}
                    />
                  </div>
              ...
              <div className="grid h-auto w-full grid-cols-2 gap-x-3 gap-y-4">
                <div className="col-span-1 flex h-[58px] w-full flex-col justify-between">
                  ...
                  <Input
                    type="string"
                    value={minInitialLiquidityAmount.toLocaleString()}
                    onChange={handleChangeMinInitialLiquidityAmount}
                    placeholder="0.0"
                    prefixEl={
                ...
                <div className="col-span-1 flex h-[58px] w-full flex-col justify-between">
                  ...
                  <div className="relative flex h-[32px] w-full items-start justify-center">
                    <Slider
                      ...
                      customValue={minSupplyDeployedPercentage}
                      onValueChange={handleChangeMinSupplyDeployedPercentage}
                      max={100}
                      step={1}
                    />
                  </div>
                ...
                <div className="col-span-1 flex h-[58px] w-full flex-col justify-between">
                  ...
                  <div className="relative flex h-[32px] w-full items-start justify-center">
                    <Slider
                      ...
                      customValue={maxSupplyDeployedPercentage}
                      onValueChange={handleChangeMaxSupplyDeployedPercentage}
                      max={100}
                      step={1}
                    />
                  </div>
                ...
                <div className="col-span-1 flex h-[58px] w-full flex-col justify-between">
                  ...
                  <div className="relative flex h-[32px] w-full items-start justify-center">
                    <Slider
                      ...
                      customValue={minTopOnePercentage}
                      onValueChange={handleChangeMinTopOnePercentage}
                      max={100}
                      step={1}
                    />
                  </div>
                ...
                <div className="col-span-1 flex h-[58px] w-full flex-col justify-between">
                  ...
                  <div className="relative flex h-[32px] w-full items-start justify-center">
                    <Slider
                      ...
                      customValue={maxTopTenPercentage}
                      onValueChange={handleChangeMaxTopTenPercentage}
                      max={100}
                      step={1}
                    />
                  </div>
                ...
                <div className="col-span-1 flex h-[58px] w-full flex-col justify-between">
                  <div className="flex items-center gap-x-1">
                    ...
                    <TooltipProvider>
                      <Tooltip>
                        <TooltipTrigger asChild>
                          <div className="relative mr-1 aspect-square h-4 w-4 flex-shrink-0">
                            <CachedImage
                              src="/icons/info-tooltip.png"
                              alt="Info Tooltip Icon"
                              fill
