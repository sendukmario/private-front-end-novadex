...
export default function AFKMoonshotForm() {
  const { moonshotStatus, setMoonshotStatus } = useAFKStatusStore();
  ...
  const handleStart = (e: FormEvent<HTMLFormElement>) => {
    ...
    setMoonshotStatus(!moonshotStatus);
