    ...
    if (isFilterApplied) {
      if (isListHovered) {
        setFilterFetchListState((prev) => {
          const updatesForExisting = aboutToGraduateList.filter((latest) =>
    ...
    <>
      {sizeVariant === "desktop" && (
        <div className="relative col-span-1 flex w-full flex-grow flex-col">
          {/* <div className="absolute -top-36 left-1/2 z-[10000] flex w-[200px] -translate-x-1/2 flex-col gap-x-1 rounded-md border border-white/30 bg-black/80 p-2 text-white">
            ...
            <div className="flex w-[200px] flex-col text-xs">
              <span>Original List Length: {aboutToGraduateList?.length}</span>
          ...
          <div className="flex w-full items-center justify-between gap-2 py-4">
            <div className="relative flex items-center gap-x-2">
              <div className="flex w-fit items-center gap-x-1.5">
                <h3
                  className={cn(
                    "line-clamp-1 font-geistSemiBold text-base text-fontColorPrimary",
                  )}
                >
                ...
                <TooltipProvider>
                  <Tooltip>
                    ...
                    <TooltipContent>
                      <p>Tokens which are about to bond</p>
                    </TooltipContent>
                  </Tooltip>
                </TooltipProvider>
              </div>
